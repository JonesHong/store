...
interface FromJDLMessageError extends FromJDLMessageBase {
  ...
  dateTimeString?: string;
  description?:
    | 'isNotMatchJDLFormatBasic'
    | 'isNotSupportedWith'
    | 'isNotSupportedRequired'
    | 'isNotMatchJDLEntity'
    | 'syntaxErrorJDLCurlyBrackets'
    | 'syntaxErrorJDLParentheses'
    | 'displayFieldMustBeUnique'
    | 'others';
}
...
interface FromJDLMessageWarning extends FromJDLMessageBase {
  ...
  dateTimeString?: string;
  description?:
    | 'isNotMatchJDLCurlyBrackets'
    | 'isNotMatchJDLParentheses'
    | 'isOnlySupportedBidirectionalRelationship';
}

export type FromJDLMessage =
  | FromJDLMessageLog
  | FromJDLMessageError
  | FromJDLMessageWarning;
...
export type RelationBuilderMethod = (
  { thisEntity, inputEntity }: { thisEntity: Entity; inputEntity?: Entity },
  options: InputRelationshipOption,
  counts?: number
) => void;

export type RelationBreakerMethod = (
  { thisEntity, inputEntity }: { thisEntity: Entity; inputEntity?: Entity },
  options: InputRelationshipOption,
  setting?: RelationBreakerSetting
) => Entity;
